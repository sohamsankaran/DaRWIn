...
task sendMessages;
void change(int GLU,int GLR,int GRU,int GRR,int NLU,
int NLR,int NRU,int NRR, int LEG1, int LEG2, int HEAD1, int HEAD2, int HEAD3);
...
////////////BHANGRA//////////////////////
  ...
  wait1Msec(1000);
  change(6,10,6,10,100,0,100,255,6,0,0,40,0);
  wait1Msec(1000);
  change(6,10,6,10,100,0,100,255,0,0,0,40,0);
  wait1Msec(1000);
  change(6,10,6,10,100,0,100,255,0,6,0,40,0);
  wait1Msec(1000);
  change(6,10,6,10,100,0,100,255,0,0,0,40,0);
  wait1Msec(1000);
  change(6,10,6,10,100,0,100,255,6,0,0,40,0);
  ...
  change(6,13,6,13,100,0,100,255,6,0,0,40,0);
  move(100,0,0,100);
  wait1Msec(1500);
  change(6,5,6,5,100,0,100,255,6,0,0,40,0);
  wait1Msec(1500);
  change(6,13,6,13,100,0,100,255,6,0,0,40,0);
  move(0,0,0,0);
  wait1Msec(1000);
