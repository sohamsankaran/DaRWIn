...
RgtSendFin = 0;
  ...
  NunchukGetParamter(S1, 0x00);          //see comment for i2c_cmd
    ...
    if(time == 10){
      ...
      nxtDisplayTextLine(5,"LSF = %4d, %4d",LftSendFin[0],LftSendFin[1]);
      nxtDisplayTextLine(6,"RSF = %4d, %4d",RgtSendFin[0],RgtSendFin[1]);
	...
	chuck1dat[0] = chuck1val[0];
	chuck1dat[0] = (255-chuck1dat[0])+100;
	//chuck1dat[0] = chuck1dat[0]+127.5;
...
task sendMessages()
{
	...
	while (true)
	{
	 ...
	 // cCmdMessageWriteToBluetooth(1,buttondat,2,mailbox1);
	  //wait1Msec(1);
	  cCmdMessageWriteToBluetooth(1,BothUp,3,mailbox1);
    wait1Msec(1);
