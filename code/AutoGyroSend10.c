...
////////////KATHAKALI////////////////////
  ...
  change(6,8,6,8,100,150,100,200,6,0,0,0,0);
  wait1Msec(1000);
  change(6,10,6,6,100,0,100,200,0,0,0,0,0);
  wait1Msec(1000);
  change(6,6,6,10,100,150,100,255,0,6,0,0,0);
  wait1Msec(1000);
  change(6,8,6,8,100,150,100,200,0,0,0,0,0);
  wait1Msec(1000);

  //RGT
  change(10,13,6,8,200,0,100,200,6,0,0,0,0);
  wait1Msec(1000);
  change(6,8,6,8,100,150,100,200,0,0,0,0,0);
  wait1Msec(1000);
  //LFT
  ...
  //RGT
  change(6,13,6,8,200,0,100,200,6,0,0,0,0);
  wait1Msec(1000);
  change(6,8,6,8,100,150,100,200,0,0,0,0,0);
  wait1Msec(1000);
  //LFT
  ...
  //RGT
  change(3,13,6,8,200,0,100,200,6,0,0,0,0);
  wait1Msec(1000);
  change(6,8,6,8,100,150,100,200,0,0,0,0,0);
  wait1Msec(1000);
  //LFT
...
////////////BHANGRA//////////////////////
  ...
  wait1Msec(1500);
  for(int i = 0; i<=10; ++i){
    change(12,10,12,10,200,0,200,255,0,6,0,0,0);
    wait1Msec(1000);
    change(6,10,6,10,100,0,100,255,0,0,0,0,0);
    wait1Msec(1000);
  }
